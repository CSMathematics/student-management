...
function NewClassroomForm({ navigateTo, classroomToEdit, initialSchedule, onSaveSuccess, onCancel, db, userId, appId, allClassrooms }) {
        ...
        <Container maxWidth="md">
            <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
                    ...
                    <Grid container spacing={2} alignItems="center">
                        ...
                        <Grid item xs={12} sm={5}>
                            <FormControl fullWidth size="small">
                                ...
                                <Select name="grade" value={formData.grade} label="Τάξη" onChange={(e) => setFormData({...formData, grade: e.target.value, specialization: '', subject: ''})} required>
                        ...
                        <Grid item xs={12} sm={2}>
                             <FormControl fullWidth>
                                <InputLabel shrink sx={{position: 'absolute', top: -18, left: -12, fontSize: '0.9rem'}}>Χρώμα</InputLabel>
                                <input
                                    type="color"
                        ...
                        {availableSpecializations.length > 0 && (
                            <Grid item xs={12} sm={6}>
                                <FormControl fullWidth size="small">
                                    ...
                                    <Select name="specialization" value={formData.specialization} label="Κατεύθυνση" onChange={(e) => setFormData({...formData, specialization: e.target.value, subject: ''})} required>
                        ...
                        <Grid item xs={12} sm={6}>
                            <FormControl fullWidth size="small">
                                ...
                                <Select name="subject" value={formData.subject} label="Μάθημα" onChange={(e) => setFormData({...formData, subject: e.target.value})} required>
                                    {currentSubjects.map(s => <MenuItem key={s} value={s}>{s}</MenuItem>)}
                                </Select>
                            </FormControl>
                        </Grid>
                        <Grid item xs={12} sm={6}>
                            <TextField fullWidth label="Μέγ. Μαθητές" name="maxStudents" type="number" value={formData.maxStudents} onChange={(e) => setFormData({...formData, maxStudents: e.target.value})} required size="small" />
                        </Grid>
                    </Grid>
                </Paper>
                    ...
                    <Grid container spacing={3} alignItems="flex-end">
                        <Grid item xs={12} sm={4}>
                            <FormControl fullWidth size="small">
                                ...
                                <Select value={selectedDay} onChange={(e) => setSelectedDay(e.target.value)} label="Ημέρα">
                        ...
                        <Grid item xs={12} sm={2}>
                            <Button variant="contained" onClick={handleAddScheduleEntry} startIcon={<Add />} fullWidth>Προσθήκη</Button>
                        </Grid>
                    </Grid>
                ...
                <Box sx={{ mt: 3, textAlign: 'right', display: 'flex', gap: 2, justifyContent: 'flex-end' }}>
                    <Button variant="outlined" color="secondary" onClick={onCancel}>Ακύρωση</Button>
                    <Button type="submit" variant="contained" color="primary">{classroomToEdit && classroomToEdit.id ? 'Ενημέρωση' : 'Αποθήκευση'}</Button>
                </Box>
            </Box>
